...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const _pages = <_Page>[
    ...
    _Page(Icons.directions_walk, 'Walk a loop',
        ...
        Color(0xFF009E73)),
    _Page(Icons.timer_outlined, 'Don’t dawdle',
        'An open trail doesn’t last forever. Take too long and the oldest part fades away, so a loop you never close is a loop you lose. Keep moving and close it.',
        Color(0xFFF0E442)),
